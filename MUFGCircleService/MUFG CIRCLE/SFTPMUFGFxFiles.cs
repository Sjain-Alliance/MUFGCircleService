...
namespace MUFGCircleService
{
    class SFTPMUFGFxFiles
    {
        ...
        public void GetSFTPDetails()
        {
            ...
            _logger.LogInformation("Get SFTP Credenitals Successfully for MUFGCircle for FX");
            if (dtSFTPCred != null)
            {
        ...
        public void ExportMUFGCircleFiles(DataSet ds)
        {
            ...
            string mufgCircleFileName = "RVUAT_MUFG_Circle_" + DateTime.Now.ToString("yyyyMMdd") + "_" + DateTime.Now.ToString("hhmmss") + ".csv";
